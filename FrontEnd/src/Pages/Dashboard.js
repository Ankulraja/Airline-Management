  ...
  return (
    <div className="bg-gradient-to-b relative from-gray-300  to-blue-600 flex flex-col items-center  text-black font-serif pt-20">
      ...
      <div className="w-[30%] z-10 h-[420px] absolute top-[23%] left-[3%]  rounded-lg bg-white flex flex-col items-center">
        ...
        <form className=" mx-auto w-[97%] h-full  mt-1 h-[60px] flex flex-col gap-3  items-center ">
          <input
          ...
          <input
            ...
            type="date"
          ></input>
          <button className="bg-blue-900 font-serif py-3 px-9 mt-7 text-white rounded-md">
            Search Flight
          </button>
        </form>
      </div>
    ...
    Welcome To <span className="w-12 h-12 mx-3  "> < img src="https://res.cloudinary.com/dkoezhi9u/image/upload/v1708422225/samples/Logo_llkrfe.png"/> </span> Airline Dashboard
    </div>
      <div className="w-[85%] border-solid text-gray-200 ">
